-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'DENTIST', 'FRONT_DESK');
...
-- CreateIndex
CREATE INDEX "Appointment_tenantId_dentistId_scheduledAt_idx" ON "Appointment"("tenantId", "dentistId", "scheduledAt");
